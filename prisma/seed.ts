  ...
  const products = [
    {
      ...
      description_ar: "أرز مصري فاخر قصير الحبة.",
      description_en: "Premium short-grain Egyptian rice.",
      pricePerKg: 35,
      stockKg: 200,
    },
    {
      ...
      description_ar: "سكر أبيض مكرر.",
      description_en: "Refined white sugar.",
      pricePerKg: 30,
      stockKg: 150,
    },
    {
      ...
      name_ar: "شاي أسود",
      name_en: "Black Tea",
      description: "Full-bodied Egyptian black tea.",
      description_ar: "شاي أسود مصري بطعم قوي.",
      description_en: "Full-bodied Egyptian black tea.",
      pricePerKg: 120,
      stockKg: 60,
    },
    {
      ...
      name_ar: "تمر سيوة",
      name_en: "Siwa Dates",
      description: "Sweet dates from Siwa Oasis.",
      description_ar: "تمر حلو من واحة سيوة.",
      description_en: "Sweet dates from Siwa Oasis.",
      pricePerKg: 90,
      stockKg: 80,
    },
    {
      ...
      description_ar: "خليط من المكسرات المحمصة.",
      description_en: "A mix of roasted nuts.",
      pricePerKg: 250,
      stockKg: 40,
    },
    {
      ...
      description_ar: "زيت عباد الشمس النقي للطهي.",
      description_en: "Pure sunflower cooking oil.",
      pricePerKg: 70,
      stockKg: 100,
    },
    {
      ...
      name_ar: "كمون",
      name_en: "Cumin",
      description: "Ground cumin spice.",
      description_ar: "كمون مطحون.",
      description_en: "Ground cumin spice.",
      pricePerKg: 180,
      stockKg: 25,
    },
  ];
